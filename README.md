...
BGP Policies : 
Annonce BGP Stable (Null0) : Injection automatique d'une route statique ipv6 route <PREFIX_AS> Null0. Permet d'utiliser la commande network BGP pour annoncer son préfixe en /32 et que la route ne soit donc pas annoncée. 
